...
import { FormSolicitudTerrenoComponent } from './views/prestamo-subsystem/form-solicitud-terreno/form-solicitud-terreno.component';

@NgModule({
  declarations: [AppComponent, FormSolicitudTerrenoComponent],
  imports: [
    MatSidenavModule,
